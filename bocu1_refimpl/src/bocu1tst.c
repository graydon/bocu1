...
testDiff() {
    ...
    printf("    BOCU1_REACH_NEG_1 %8d    BOCU1_REACH_POS_1 %8ld\n", BOCU1_REACH_NEG_1, BOCU1_REACH_POS_1);
    printf("    BOCU1_REACH_NEG_2 %8d    BOCU1_REACH_POS_2 %8ld\n", BOCU1_REACH_NEG_2, BOCU1_REACH_POS_2);
    printf("    BOCU1_REACH_NEG_3 %8d    BOCU1_REACH_POS_3 %8ld\n", BOCU1_REACH_NEG_3, BOCU1_REACH_POS_3);
    puts("");

    printf("    BOCU1_TRAIL_COUNT 0x%02x\n", BOCU1_TRAIL_COUNT);
    ...
    printf("    BOCU1_START_NEG_4 0x%02x    BOCU1_START_POS_4 0x%02x\n", BOCU1_START_NEG_4, BOCU1_START_POS_4);
    puts("");
